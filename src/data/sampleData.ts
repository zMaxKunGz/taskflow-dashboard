...
export const tasks: Task[] = [
  {
    ...
    subtasks: [
      ...
      { id: '1-4', title: 'Get stakeholder feedback', completed: false },
    ],
  },
  {
    id: '2',
    ...
    subtasks: [
      { id: '2-1', title: 'Set up OAuth providers', completed: true },
      { id: '2-2', title: 'Create login UI', completed: true },
      { id: '2-3', title: 'Implement token management', completed: true },
    ],
  },
  {
    id: '3',
    ...
    subtasks: [
      { id: '3-1', title: 'Profile current queries', completed: true },
      { id: '3-2', title: 'Implement Redis caching', completed: false },
      { id: '3-3', title: 'Load testing', completed: false },
    ],
  },
  {
    id: '4',
